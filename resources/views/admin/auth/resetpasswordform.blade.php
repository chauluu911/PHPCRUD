						...
						<div class="login-form login-signin">
							...
							<form class="form"  method='POST' action="">
								...
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Change your password</h3>
								</div>
								<!--begin::Title-->
								<!--begin::Form group-->
								...
								<div class="pb-lg-0 pb-5">
									<button type="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Change My Password</button>
								</div>
								<!--end::Action-->
							</form>
							<!--end::Form-->
