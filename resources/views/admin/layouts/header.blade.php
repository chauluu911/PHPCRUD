						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="topbar">
								...
								<div class="topbar-item">
									<a href="#" style="font-size: 15px ;margin-right: 11px; color: black; font-weight:bold;">{{auth()->user()->name}}</a>
								</div>
								<div class="topbar-item">
									<a href="{{route('logout')}}"><button class="btn btn-danger">{{trans('web.logout')}}</button></a>
								</div>
								<!--end::User-->
							</div>
							<!--end::Topbar-->
